...
public record ToolDetailResponse(Long id, String slug, String name, String summary, String officialUrl,
                                 String coverUrl, PublicCategoryResponse category, List<PublicTagResponse> tags,
                                 boolean featured, Instant publishedAt, String renderedHtml) {
}
