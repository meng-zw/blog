...
public record AdminToolSummaryResponse(Long id, String slug, String name, String summary, String officialUrl,
                                       String coverUrl, CategoryResponse category, List<TagResponse> tags,
                                       ToolStatus status, boolean featured, int sortOrder, Instant publishedAt,
