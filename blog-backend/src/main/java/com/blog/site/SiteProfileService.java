...
public class SiteProfileService {
    ...
    @Transactional
    public SiteProfileResponse update(UpdateSiteProfileRequest request) {
        ...
        return responseFor(siteProfileRepository.save(profile));
    }
    ...
    private static SiteProfileResponse responseFor(SiteProfile profile) {
